...
import guru.springframework.repository.CategoryRepo;
import guru.springframework.repository.RecipeRepo;
import guru.springframework.repository.UnitOfMeasureRepo;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> pinchUomOptional = unitOfMeasureRepo.findByDescription("Pinch");
