...
public class RecipeBoostrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBoostrap(UnitOfMeasureRepository unitOfMeasureRepository, CategoryRepository categoryRepository, RecipeRepository recipeRepository) {
